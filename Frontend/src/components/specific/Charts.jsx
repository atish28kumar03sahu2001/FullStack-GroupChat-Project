...
import { purpleColor, orangeLight, purple, purpleLight } from "../../constants/color";
...
const LineChart = ({ value = [] }) => {
  const data = {
    labels,
    datasets: [
      { data: value, label: "Messages", fill: true, backgroundColor: purpleLight, borderColor: purple },
    ],
  };
...
const DoughnutChart = ({ value = [], labels = [] }) => {
  const data = {
    labels,
    datasets: [
      { data: value, backgroundColor: [purpleLight, orangeLight], hoverBackgroundColor: [purple, purpleColor], borderColor: [purple, purpleColor], offset: 40, },
    ],
  };
  return (
