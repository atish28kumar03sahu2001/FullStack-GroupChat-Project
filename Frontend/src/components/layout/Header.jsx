...
const Header = () => {
  ...
  return (
    <>
      <Box sx={{ flexGrow: 1 }} height={"6.7rem"}>
        <AppBar position="static" sx={{ bgcolor: purpleColor, height: "80px" }}>
          <Toolbar>
            <Typography variant="h4" sx={{ display: { xs: "none", sm: "block" },}} > ChatPulse </Typography>
