...
import { grayColor, purpleColor } from "../constants/color";
    ...
    <Fragment>
      ...
      <form style={{ height: "10%" }} onSubmit={submitHandler} >
        <Stack direction={"row"} height={"100%"} padding={"1rem"} alignItems={"center"} position={"relative"} >
          ...
          <InputBox placeholder="Type Message Here..." value={message} onChange={messageOnChange} sx={{fontSize: "13px"}} />

          <IconButton type="submit" sx={{ rotate: "-30deg", bgcolor: purpleColor, color: "white", marginLeft: "1rem", padding: "0.5rem", "&:hover": { bgcolor: "error.dark" } }}>
            <SendIcon />
          </IconButton>
        </Stack>
      </form>
